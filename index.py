...
def main():
    ...
    #     print(film)
    uploader = S3Uploader()
    uploader.upload_image_from_url('https://images.unsplash.com/photo-1566024164372-0281f1133aa6?q=80&w=3464&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')
